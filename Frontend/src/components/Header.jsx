...
export default function Header() {
  ...
  // Get all auth states including loading and logout function
            ...
            {isLoading ? (
              ...
              <div className="flex items-center space-x-3">
                ...
                <button
                  ...
                  className="flex items-center space-x-1 text-sm font-medium text-red-600 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300 transition-all duration-200 px-3 py-2 rounded-lg hover:bg-red-50 dark:hover:bg-red-900/20 transform hover:scale-105 active:scale-95"
                >
              ...
              {isLoading ? (
                ...
                <>
                  <NavLink
                    to="/dashboard"
                    onClick={() => setIsMenuOpen(false)}
                    className="block w-full text-center text-sm font-medium text-teal-600 border border-teal-600 px-4 py-3 rounded-lg hover:bg-teal-50 dark:hover:bg-teal-900/20 transition-all duration-200 transform active:scale-95"
                  >
                    Go to Dashboard
                  </NavLink>
                  <button
                    onClick={handleLogout}
                    className="flex items-center justify-center space-x-2 w-full text-center text-sm font-medium text-red-600 border border-red-600 px-4 py-3 rounded-lg hover:bg-red-50 dark:hover:bg-red-900/20 transition-all duration-200 transform active:scale-95"
                  >
                    <LogOut className="h-4 w-4" />
                    <span>Logout</span>
                  </button>
